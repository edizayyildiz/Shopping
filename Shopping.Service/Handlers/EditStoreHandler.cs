...
namespace Shopping.Service.Handlers
{
    ...
    {
        private readonly IRepository<Shopping.Model.Entities.Store> storeRepository;
        private readonly IUnitOfWork unitOfWork;
        public EditStoreHandler(IUnitOfWork unitOfWork, IRepository<Shopping.Model.Entities.Store> storeRepository)
        {
        ...
        public override async Task<dynamic> HandleAsync(Commands.EditStore command)
        {
            ...
            var model = Mapper.Map<Shopping.Model.Entities.Store>(command);
